...
MESSAGE_DURATION = 5000  # Duration for terminal messages 5 seconds
MESSAGE_DURATION_WRONG = 1500   # Duration for terminal wrong input message 3 seconds
ALARM_FLASH_INTERVAL = 500
CUTSCENE_CHAR_DELAY = 35
