...
class GameManager:
    ...
    def _draw_game_over_screen(self, surface):
        ...
        surface.fill(BLACK)
        self._draw_centered_text(surface, "MISSION FAILED - GAME OVER", FONT_LG, RED, HEIGHT // 2 - 50)
        self._draw_centered_text(surface, "Oxygen Depleted or Suit Breached!", FONT_MD, WHITE, HEIGHT // 2)
        self._draw_centered_text(surface, "Press ESC to exit", FONT_MD, WHITE, HEIGHT // 2 + 50)

    def _draw_win_screen(self, surface):
        """Draws the win screen."""
        surface.fill(BLACK)
        self._draw_centered_text(surface, "MISSION SUCCESS! Distress Signal Sent!", FONT_LG, GREEN, HEIGHT // 2 - 50)
        self._draw_centered_text(surface, "You have saved humanity!", FONT_MD, WHITE, HEIGHT // 2)
        self._draw_centered_text(surface, "Press ESC to exit", FONT_MD, WHITE, HEIGHT // 2 + 50)
